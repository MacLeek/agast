...
// libcvd
__inline__ void agast_corner_detect12d(const CVD::BasicImage<CVD::byte>& im,
...
// opencv
__inline__ void agast_corner_detect12d(const cv::Mat& im,
                                       std::vector<CVD::ImageRef>& corners,
                                       int barrier) {
...
// libcvd
__inline__ void oast_corner_detect16(const CVD::BasicImage<CVD::byte>& im,
                                     std::vector<CVD::ImageRef>& corners,
                                     int barrier) {
  detector.set_imageSize(im.size().x, im.size().y);
  detector.set_threshold(barrier);
...
// opencv
__inline__ void oast_corner_detect16(const cv::Mat& im,
                                     std::vector<CVD::ImageRef>& corners,
                                     int barrier) {
  detector.set_imageSize(im.size().width, im.size().height);
  detector.set_threshold(barrier);
